...
namespace Feedling
{
    internal class TypefaceListItem : TextBlock, IComparable
    {
        ...
        public TypefaceListItem(Typeface typeface)
        {
            ...
            if (_simulated)
            {
                //string formatString = FontDialogSample.Properties.Resources.ResourceManager.GetString("simulated", CultureInfo.CurrentUICulture);
                string formatString = "simulated_resource_string";
